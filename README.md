...
•	Clicking on any task should expand and show the notes under it and show an
        input box to add more notes to it
...
•	Task and notes data should be saved in a database 
       (you can use SQLITE with Sequelize) 
